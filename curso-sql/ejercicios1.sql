...
select * from ofertas join ofertas_usuarios where usuario_id = 3;
...
select o.titulo, count(usuario_id) as cont from ofertas o  join ofertas_usuarios ou on o.id = ou.oferta_id group by titulo order by cont desc;